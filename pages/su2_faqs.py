...
# ─── FAQ 12 ────────────────────────────────────────────────────────────── 
with st.expander("Q11: What are the steps involved in compiling SU2 from source on Windows 11?"): 
    ...
    st.write("Also the time to compile and link from startto finish was only 2 to 3 minutes on my Windows 11 system - nowhere like the half hour or more quoted in the literature.")
