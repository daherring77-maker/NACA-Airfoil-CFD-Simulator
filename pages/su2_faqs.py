...
with st.expander("Q12: What are the steps involved in compiling SU2 from source on Windows 11?"): 
    ...
    st.write("You will probably want to optimize the code using AVX or a different instruction set. This is best done using an arg parameter to the meson command")
