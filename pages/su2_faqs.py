...
with st.expander("Q12: What are the steps involved in compiling SU2 from source on Windows 11?"): 
    ...
    st.write("However, the code is passing a std::array iterator. On Linux (GCC), iterators often secretly act like raw pointers, but the Microsoft compiler is strictly enforcing the C++ standard and refusing to convert th""You will probably e iterator to a pointer.")
